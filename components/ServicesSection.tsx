...
export default function ServicesSection() {
  ...
  return (
    <section ref={sectionRef} id="services" className="section-padding bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cdefs%3E%3Cpattern%20id%3D%22grid%22%20width%3D%2260%22%20height%3D%2260%22%20patternUnits%3D%22userSpaceOnUse%22%3E%3Cpath%20d%3D%22M%2060%200%20L%200%200%200%2060%22%20fill%3D%22none%22%20stroke%3D%22rgba(0%2C0%2C0%2C0.03)%22%20stroke-width%3D%221%22%2F%3E%3C%2Fpattern%3E%3C%2Fdefs%3E%3Crect%20width%3D%22100%25%22%20height%3D%22100%25%22%20fill%3D%22url(%23grid)%22%2F%3E%3C%2Fsvg%3E')] opacity-50"></div>
      
      <div className="container relative z-10">
        <div className="text-center mb-12 md:mb-16">
          <div className={`inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-full mb-6 ${isInView ? 'animate-bounce-in' : 'opacity-0'}`}>
            <span className="text-blue-600 font-medium text-sm">Not Your Average Dev Shop</span>
          </div>
          ...
          <p className={`text-lg text-gray-600 max-w-2xl mx-auto ${isInView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className={`h-full p-6 rounded-2xl border transition-all duration-500 ${
                activeService === index
                  ? 'bg-white shadow-xl border-gray-200 scale-105'
                  : 'bg-white/80 border-gray-100 hover:border-gray-200 hover:shadow-lg'
              } backdrop-blur-sm`}>
                {/* Icon and title */}
                <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 line-clamp-3 mb-4 lg:hidden">
                  {service.description}
                </p>
